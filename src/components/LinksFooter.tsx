// Enhanced by AI on 2025-08-14T14:51:54.936Z
// Section: footer
// Category: footer
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl">Parapharmacy</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Providing high-quality parapharmacy products and services to our customers. 
                Shop our wide selection of health and wellness items.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">info@parapharmacy.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 Parapharmacy. All rights reserved.</span>
