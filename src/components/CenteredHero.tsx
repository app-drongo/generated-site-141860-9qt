// Enhanced by AI on 2025-08-14T14:51:23.532Z
// Section: hero
// Category: hero
...
export default function ParapharmacyHero() {
  return (
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Explore our wide range of high-quality parapharmacy products, carefully curated to meet your health and wellness needs.
            </p>
              ...
              <div className="rounded-2xl border bg-card p-2 shadow-2xl">
                <div className="rounded-xl bg-gradient-to-br from-muted/50 to-muted aspect-video flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground">Product Showcase</p>
                  </div>
                </div>
              </div>
